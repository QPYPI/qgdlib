...
public class GDActivity extends Activity implements ActionBarActivity {
    ...
    protected void ensureLayout() {
        ...
        if (mDefaultConstructorUsed) {
            //if(Type.Drawer==mActionBarType){
        	 mDrawerLayout=(DrawerLayout) findViewById(R.id.gd_drawer_layout);
             if(mDrawerLayout!=null) {
            	 mActionBarType = Type.Drawer;
             	//throw new RuntimeException("Your content must have an mDrawerLayout whose id attribute is R.id.drawer_layout");
             }
            //}
    ...
    public void closeDrawer(View arg0){
   	 	mDrawerLayout=(DrawerLayout) findViewById(R.id.gd_drawer_layout);
    ...
    public void openDrawer(int gravity){
   	 	mDrawerLayout=(DrawerLayout) findViewById(R.id.gd_drawer_layout);
   	 	Log.d(LOG_TAG, "mDrawerLayout:"+mDrawerLayout);

    	mDrawerLayout.openDrawer(gravity);
    }
    
    public void openDrawer(DrawerLayout v){
    	if (mActionBarType == Type.Drawer) {
	   	 	mDrawerLayout=(DrawerLayout) findViewById(R.id.gd_drawer_layout);
	   	 	//mDrawerLayout.bringToFront();
	   	 	//mDrawerLayout.scrollTo(-240, 0);
            ...
            if (position == OnActionBarListener.HOME_ITEM) {
                ...
                switch (mActionBarType) {
                    ...
                    case Dashboard:
                        ...
                        break;
                    case Drawer:
                    	Log.d(LOG_TAG, "Drawer clicked");
                    	openDrawer((DrawerLayout)findViewById(R.id.gd_drawer_layout));
                }
